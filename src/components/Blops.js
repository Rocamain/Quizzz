...
export default function Blops(props) {
      ...
      <div className={`blop-container-top--${classType}`}>
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M99.4095 102.395C71.1213 71.8507 33.3179 42.7816 37.1728 1.30671C41.4394 -44.599 75.8541 -84.3588 118.419 -102.133C158.797 -118.994 206.035 -109.256 241.822 -84.1494C271.947 -63.0141 272.823 -22.8756 282.141 12.729C292.17 51.0508 318.521 91.8106 296.501 124.779C273.539 159.159 224.991 164.432 183.931 159.768C148.318 155.723 123.751 128.677 99.4095 102.395Z"
            fill="#FFFAD1"
          />
        </svg>
      </div>
      <div className={`blop-container-bottom--${classType}`}>
        <svg
          className="blop-bottom"
          width="100%"
          height="100%"
          viewBox="0 0 148 118"
          fill="none"
